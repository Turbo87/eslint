    ...
    describe("executeOnFiles()", function() {
        ...
        describe("cache", function() {
            ...
            describe("when the cacheFile is a directory or looks like a directory", function() {
                ...
                */
                ...
                it("should create the cache file inside the provided directory", function() {
                    assert.isFalse(pathUtil.isDirectory(path.resolve("./tmp/.cacheFileDir/.cache_hashOfCurrentWorkingDirectory")), "the cache for eslint does not exist");
                    ...
                    assert.isTrue(pathUtil.isFile(path.resolve("./tmp/.cacheFileDir/.cache_" + hash(process.cwd()))), "the cache for eslint was created");
            ...
            it("should create the cache file inside cwd when no cacheLocation provided", function() {
                ...
                assert.isTrue(pathUtil.isFile(path.resolve(cwd, ".eslintcache")), "the cache for eslint was created at provided cwd");
            });

            it("should invalidate the cache if the configuration changed between executions", function() {
                assert.isFalse(pathUtil.isFile(path.resolve(".eslintcache")), "the cache for eslint does not exist");
                ...
                assert.isTrue(pathUtil.isFile(path.resolve(".eslintcache")), "the cache for eslint was created");
            ...
            it("should remember the files from a previous run and do not operate on then if not changed", function() {
                ...
                assert.isFalse(pathUtil.isFile(cacheFile), "the cache for eslint does not exist");
                ...
                assert.isTrue(pathUtil.isFile(cacheFile), "the cache for eslint was created");
                ...
                assert.isFalse(pathUtil.isFile(cacheFile), "the cache for eslint was deleted since last run did not used the cache");
            });
            ...
            it("should not delete cache when executing on text", function() {
                ...
                assert.isTrue(pathUtil.isFile(cacheFile), "the cache for eslint exists");

                engine.executeOnText("var foo = 'bar';");

                assert.isTrue(pathUtil.isFile(cacheFile), "the cache for eslint still exists");
            });
            ...
            it("should delete cache when executing on files without --cache flag", function() {
                ...
                assert.isFalse(pathUtil.isFile(cacheFile), "the cache for eslint has been deleted");
            });
            ...
            describe("cacheFile", function() {
                it("should use the specified cache file", function() {
                    ...
                    assert.isFalse(pathUtil.isFile(customCacheFile), "the cache for eslint does not exist");
                    ...
                    assert.isTrue(pathUtil.isFile(customCacheFile), "the cache for eslint was created");
